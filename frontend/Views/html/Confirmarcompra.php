...
<?php
	if ($transationData['statusCode'] == 3) {
?>
<!--  -->
...
<!--  -->
	<section class="mt-10 container px-8" data-aos="fade-up" data-aos-delay="0">
		<div class="text-center d-block">
			<img class="width-100-rp" src="<?= MEDIA_STORE; ?>images/canceled-buy.png" alt="">
			<p class="mt-5 mb-8 fs-18 font-weight-bold"><?=$transationData['message'];?></p>
		</div>
	</section>
<!--  -->
<?php
	...
	<section class="pt-5 container px-8" data-aos="fade-up" data-aos-delay="0">
		<div class="row">
			<div class="col-lg-6">
				...
				<p class="mb-0 font-weight-bold"><?=$transationData['cardType']." / ".$transationData['cardBrand'];?></p>
