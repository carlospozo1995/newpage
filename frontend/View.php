<?php
	...
	class View{
		static public function renderPage($namePage, $template_vars = array())
		{
			...
			if ($namePage == 'Dashboard' || $namePage == 'Roles' || $namePage == 'Users' || $namePage == 'User' || $namePage == 'Categories' || $namePage == 'Products' || $namePage == 'Banners' || $namePage == 'Pedidos' || $namePage == "Orden") {
			...
			if($namePage == 'Index' || $namePage == 'Test' || $namePage == 'Categoria' || $namePage == 'Producto' || $namePage == 'Carrito' || $namePage == 'Resultado' || $namePage == 'Payment' || $namePage == 'Confirmarcompra' || $namePage == 'Confirmarpedido'){
