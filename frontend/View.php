<?php
	...
	class View{
		static public function renderPage($namePage, $template_vars = array())
		{
			...
			if($namePage == 'Index' || $namePage == 'Test' || $namePage == 'Categoria' || $namePage == 'Producto' || $namePage == 'Carrito' || $namePage == 'Payment' || $namePage == 'Confirmarcompra' || $namePage == 'Confirmarpedido'){
