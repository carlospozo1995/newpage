...
-- Tiempo de generación: 21-10-2023 a las 03:35:51
...
--
ALTER TABLE `card_transaction`
  MODIFY `id_transaccion` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=283;
...
--
ALTER TABLE `detail_orders`
  MODIFY `id_detail` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
...
--
ALTER TABLE `orders`
  MODIFY `id_order` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
