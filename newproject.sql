...
-- Tiempo de generación: 09-12-2023 a las 05:57:12
...
(40, 193, 654642138, 'Refrigeradora Smart Samsung 685 Litros', 'Lo mejor en línea blanca lo obtienes con Samsung', NULL, NULL, NULL, NULL, NULL, NULL, 'SAMSUNG', 900.00, 5, 1000.00, 8, NULL, NULL, '2023-12-09 00:32:23', 'refrigeradora-smart-samsung-685-litros', 1);
...
--
ALTER TABLE `img_product`
  MODIFY `id_img` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `products`
  MODIFY `id_product` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
