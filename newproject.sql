...
-- Tiempo de generación: 25-11-2023 a las 06:23:45
...
(246, 255, 'Belleza', NULL, 'bannerlg_Belleza_f3b5b1e763451997a52e00ae7eab39be.jpg', NULL, NULL, NULL, NULL, 'cuidado-personal/belleza', 2),
...
CREATE TABLE `banners_product` (
  ...
  `banner_name` varchar(100) COLLATE utf8mb4_swedish_ci NOT NULL,
  `banner_large` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
  `banner_horizontal` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
  `banner_offers` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
  `sliderDst` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
  `sliderMbl` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
...
INSERT INTO `banners_product` (`id_banner`, `product_id`, `banner_name`, `banner_large`, `banner_horizontal`, `banner_offers`, `sliderDst`, `sliderMbl`, `sliderDes`, `redirect`, `banner_type`) VALUES
(16, 1, 'Cocina A Gas 4 Quemadores Em5100eb0', NULL, NULL, NULL, 'sliderDst_cocina-a-gas-4-quemadores-blanca-mabe-em5100eb0_bd5a6a28b71c7939d63f9325bbe51c4b.jpg', 'sliderMbl_cocina-a-gas-4-quemadores-blanca-mabe-em5100eb0_ff937cd43dcb5283c7b4292ae7606ed7.jpg', NULL, 'cocina-a-gas-4-quemadores-em5100eb0', 1),
(17, 2, 'Minicomponente 1 cuerpo JBLPARTYBOX710AM', NULL, NULL, NULL, 'sliderDst_minicomponente-1-cuerpo-jblpartybox710am_1df83af9d0cf399ff5eddc8b213486d3.jpg', 'sliderMbl_minicomponente-1-cuerpo-jblpartybox710am_ed205aebb547b1cbda8287fb3639d4f7.jpg', 'LLEVA LA FIESTA A TODAS PARTES', 'minicomponente-1-cuerpo-jblpartybox710am', 1);
...
--
ALTER TABLE `banners_category`
  MODIFY `id_banner` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=260;

--
-- AUTO_INCREMENT de la tabla `banners_product`
--
ALTER TABLE `banners_product`
  MODIFY `id_banner` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `img_product`
  MODIFY `id_img` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `products`
  MODIFY `id_product` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
